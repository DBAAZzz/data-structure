...
/**
 * any类型，在TypeScript中任何类型都可以被归类为any类型。
...
/**
 * void类型，void类型像是与any类型相反，它没有表示任何类型。
...
/**
 * tuple类型，元组是TypeScript中特有的类型，其工作方式类似于数组
...
/**
 * interface 接口是TypeScript中的核心知识，能合并众多类型声明至一个类型声明
 */
interface Name {
    first: string
    second: string
